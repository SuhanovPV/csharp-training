...
namespace WebAddressbookTests
{
    ...
    public class ContactCreationTests
    {
        ...
        private void FillContactForm(ContactData contact)
        {
            ...
            driver.FindElement(By.XPath(String.Format("//option[@value='{0}']", contact.Bday))).Click();
            new SelectElement(driver.FindElement(By.Name("bmonth"))).SelectByText(contact.Bmonth);
            driver.FindElement(By.XPath(String.Format("//option[@value='{0}']", contact.Bmonth))).Click();
            driver.FindElement(By.Name("byear")).Clear();
            driver.FindElement(By.Name("byear")).SendKeys(contact.Byear);
            new SelectElement(driver.FindElement(By.Name("aday"))).SelectByText(contact.Aday);
            driver.FindElement(By.XPath("(//option[@value='16'])[2]")).Click();
            driver.FindElement(By.XPath(String.Format("(//option[@value='{0}'])[2]", contact.Aday))).Click();
            new SelectElement(driver.FindElement(By.Name("amonth"))).SelectByText(contact.Amonth);
            driver.FindElement(By.XPath("(//option[@value='December'])[2]")).Click();
            driver.FindElement(By.XPath(String.Format("(//option[@value='{0}'])[2]", contact.Amonth))).Click();
